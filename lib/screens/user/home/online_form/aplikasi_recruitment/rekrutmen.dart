...
class Rekrutmen extends StatelessWidget {
  ...
  String getText(int index) {
    ...
    switch (index) {
      case 0:
        return 'Aplikasi Rekrutment';
      case 1:
        return 'Assign Interview';
      case 2:
        return 'Form Hasil Interview';
      default:
        return 'Error';
    }
  }
  ...
  void handleIconTap(int index) {
    switch (index) {
      ...
      case 2:
        Get.toNamed(
            '/user/main/home/online_form/pengajuan_cuti/form_aplikasi_rekrutmen');
        break;
      default:
        return print('Error');
    }
