...
class DemografiAttendanceScreen extends StatefulWidget {
  @override
  State<DemografiAttendanceScreen> createState() => _DemografiAttendanceScreenState();
}
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: SfCartesianChart(
                title: ChartTitle(text: 'Jumlah Karyawan'),
                ...
                series: <CircularSeries>[
                  DoughnutSeries<AttendanceData, String>(
                    ...
                    if (data.category == 'Normal') {
                      return Colors.lightBlue; // Use the appropriate color for light blue
                    } else if (data.category == 'Terlambat') {
                      return Colors.blue[900]; // Use the appropriate color for navy blue
                    } else {
