...
class TabsRawatJalan extends StatefulWidget {
  const TabsRawatJalan({super.key});

  @override
  State<TabsRawatJalan> createState() => _TabsRawatJalanState();
}

class _TabsRawatJalanState extends State<TabsRawatJalan>
