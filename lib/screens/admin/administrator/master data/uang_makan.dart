...
class UangMakan extends StatefulWidget {
  const UangMakan({super.key});

  @override
  State<UangMakan> createState() => _UangMakanState();
}

class _UangMakanState extends State<UangMakan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: const Text('Master Data - Uang Makan'),
      ),
